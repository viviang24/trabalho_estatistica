...
Usamos operadores para calcular, comparar e atribuir:
...
Vale ressaltar tipos de estruturas ``mutáveis`` podem ser alterados após operado e ``imutáveis`` nâo recebem alterações após operados. São eles:
